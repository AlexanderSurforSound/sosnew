        ...
        {isOpen && (
          ...
          >
            <div className="p-3 border-b border-gray-100">
              <p className="text-sm font-medium text-gray-900">Share this property</p>
            </div>
            ...
            <div className="p-2">
              ...
              <div className="grid grid-cols-5 gap-1 mb-3">
                {shareOptions.map((option) => (
                  <button
                    ...
                    className={`flex flex-col items-center gap-1 p-2 rounded-lg transition-colors ${option.color}`}
                    title={option.name}
                  >
                    {option.icon}
              ...
              <div className="flex items-center gap-2 p-2 bg-gray-50 rounded-lg">
                <input
                  ...
                  value={shareUrl}
                  readOnly
                  className="flex-1 text-sm bg-transparent text-gray-600 truncate outline-none"
                />
                <button
                  onClick={handleCopyLink}
                  className="px-3 py-1.5 bg-ocean-600 text-white text-sm font-medium rounded-lg hover:bg-ocean-700 transition-colors whitespace-nowrap"
                >
                  {copied ? 'Copied!' : 'Copy'}
                </button>
              </div>
